// =============================================================================
// CandidateChecklistReport — safe presentation of checklist v2 feedback for the
// CANDIDATE side. Receives a pre-adapted view (see adaptCandidateChecklist) so
// employer-only fields (expected_answer, risks, red_flags, gaps, evidence,
// employer_feedback, criteria) never reach this component's props or DOM.
// =============================================================================
import { type CandidateChecklistView } from "@/lib/feedbackAdapters";

type Props = {
  view: CandidateChecklistView;
  score?: number | null;
};

export default function CandidateChecklistReport({ view, score }: Props) {
  if (view.kind === "empty") {
    return (
