...
РАСЧЕТ БАЛЛОВ: Всего вопросов ${questionsForAi.length}. Максимальная сумма за все вопросы ровно 100 баллов. Распределяй баллы ровно поровну между всеми вопросами.
