...
BEGIN
  ...
  SELECT
    ...
    (cs.resume_score IS NOT NULL),
    (cs.checklist_score IS NOT NULL),
    (cs.situations_score IS NOT NULL),
    (cs.overall_score IS NOT NULL),
    COALESCE((
    ...
    CASE
      ...
      WHEN cs.overall_score IS NOT NULL THEN 'final'
      WHEN cs.situations_score IS NOT NULL THEN 'situations'
      WHEN cs.checklist_score IS NOT NULL THEN 'checklist'
      WHEN cs.resume_score IS NOT NULL THEN 'screening'
      ELSE 'registration'
    END
